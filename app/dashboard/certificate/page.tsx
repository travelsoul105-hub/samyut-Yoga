...
export default function CertificatePage() {
  ...
  return (
    <div className="p-6 lg:p-8 max-w-2xl">
      <h1 className="font-cormorant text-4xl font-semibold text-forest mb-2">Your Certificate</h1>
      ...
      {!isComplete ? (
          ...
          <div className="relative bg-forest/5 p-10 text-center border-b border-forest/10">
            <div className="max-w-sm mx-auto border-2 border-gold/30 p-8 opacity-50">
              <div className="flex items-center justify-center gap-3 mb-3">
                ...
                <span className="text-gold text-xs font-inter tracking-widest">SAMYUT YOGA</span>
                <div className="h-px w-8 bg-gold/50" />
              </div>
              <p className="font-cormorant text-2xl font-semibold text-forest mb-1">Certificate of Completion</p>
              <p className="font-cormorant text-lg italic text-gold mb-3">200hrs Ashtanga Yoga TTC</p>
              <p className="text-charcoal/50 font-inter text-sm">Sarah Johnson</p>
            ...
            <div className="absolute inset-0 flex items-center justify-center">
              <div className="bg-white/90 border border-forest/20 rounded-sm px-5 py-3 flex items-center gap-2">
                ...
                <span className="font-inter text-sm text-charcoal/70">Complete the course to unlock</span>
              </div>
            </div>
          </div>
          <div className="p-6">
            ...
            <div className="flex items-center justify-between mb-2">
              <span className="font-inter text-sm text-charcoal/70">Course Progress</span>
              <span className="font-inter text-sm font-semibold text-forest">{mockProgress}%</span>
            </div>
            ...
            <p className="text-charcoal/55 font-inter text-xs leading-relaxed">
        ...
        <div className="bg-white border border-forest/10 rounded-sm p-8 text-center">
          ...
          <h2 className="font-cormorant text-3xl font-semibold text-forest mb-2">Congratulations! 🎉</h2>
          <p className="text-charcoal/65 font-inter text-sm mb-6">Your Samyut Yoga certificate is ready to download.</p>
          <button onClick={downloadCertificate}
            className="flex items-center gap-2 bg-forest text-ivory px-6 py-3 rounded font-inter font-medium text-sm hover:bg-forest-light transition-colors mx-auto mb-6">
            <Download className="w-4 h-4" /> Download Certificate (PDF)
          </button>
          <div className="border-t border-forest/10 pt-5">
            <h3 className="font-cormorant text-lg font-semibold text-forest mb-3">Register with Yoga Alliance</h3>
            <p className="text-charcoal/60 font-inter text-xs leading-relaxed mb-3">
            ...
            <a href="https://www.yogaalliance.org" target="_blank" rel="noopener noreferrer"
              className="text-forest font-inter text-xs underline hover:text-gold transition-colors">
