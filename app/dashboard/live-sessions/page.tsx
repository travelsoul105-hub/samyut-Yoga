export default function LiveSessionsPage() {
  return (
    <div className="p-6 lg:p-8 max-w-3xl">
      <h1 className="font-cormorant text-4xl font-semibold text-forest mb-2">Live Sessions</h1>
      ...
      <div className="bg-white border border-forest/10 p-6 rounded-sm mb-6">
        <h2 className="font-cormorant text-xl font-semibold text-forest mb-3">Personal Consultation</h2>
        <p className="text-charcoal/65 font-inter text-sm leading-relaxed mb-5">
        ...
        <div className="bg-forest/5 border border-forest/15 rounded-sm p-10 text-center">
          <p className="text-charcoal/50 font-inter text-sm mb-4">Cal.com Booking Widget (embedded here)</p>
          <a href="https://cal.com" target="_blank" rel="noopener noreferrer"
            className="bg-forest text-ivory px-6 py-3 rounded font-inter font-medium text-sm hover:bg-forest-light transition-colors inline-block">
      ...
      <div className="bg-gold/10 border border-gold/30 p-5 rounded-sm">
        <h3 className="font-cormorant text-lg font-semibold text-charcoal mb-2">Guidelines</h3>
        <ul className="space-y-2">
          {[
            ...
            <li key={g} className="flex items-start gap-2 text-xs font-inter text-charcoal/70">
